...
<style>
    ...
    <div class="card mb-3">
        <div class="card-body d-flex gap-4">
            <img src="{{ asset('assets/img/foto.3.webp') }}" alt="" style="width: 250px; height:250px">
            <div class="desc w-100">
                <p style="font-size:24px; font-weight:700;">Makanan Snack </p>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-5 d-flex">
                        ...
                        <input type="number" name="qty" class="form-control w-25 text-center"   id="qty" min="0" value="1" max="9999">
                ...
                <div class="row">
                    ...
                    <input type="text" class="col-sm-2 form-control w-25 border-0 fs-5" readonly id="total" value="Rp. 200.000">
                </div>
