...
<body>
  ...
  <main>
    {{-- <div style="margin-left: 280px; width:82%; margin-top:10px;"> --}}
        <div class="card p-4 m-auto" style="width: 34vw">
            ...
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                      <input type="username"  class=" p-2 form-control-plaintext" id="username" name="usernaame" value="" autocomplete="off" autofocus>
                    </div>
                  </div>
                  <div class="mb-3 row">
