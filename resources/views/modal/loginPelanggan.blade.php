    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3 row">
                <label for="username" class="col-sm-3 col-form-label">Ussername</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="username" value="" placeholder="Masukkan ussername Anda">
                </div>
          </div>
          <div class="mb-3 row">
                <label for="password" class="col-sm-3 col-form-label">Password</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="password" value="" placeholder="Masukkan password Anda">
                </div>
         </div>
